...
'''
print(my_html)
formate_html = BeautifulSoup(my_html,'html.parser')
print(formate_html.prettify())

print(formate_html.title)
print(formate_html.title.name)
print(formate_html.title.string)
print(formate_html.title.parent.name)